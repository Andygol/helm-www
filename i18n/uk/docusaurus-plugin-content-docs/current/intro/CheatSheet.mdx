...
helm install <name> <chart> --force-replace           # Примусове оновлення ресурсів шляхом заміни
...
helm upgrade <release> <chart> --force-replace            # Примусове оновлення ресурсів з використанням стратегії заміни.
