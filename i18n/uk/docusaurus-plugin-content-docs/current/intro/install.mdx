...
Після цього ви зможете запустити клієнта та [знайти чарти для встановлення](/intro/quickstart.md#find-charts-to-install): `helm help`.
...
Після успішного встановлення клієнта Helm ви можете перейти до використання Helm для управління чартами та [знайти чарти для встановлення](/intro/quickstart.md#find-charts-to-install).
