...
Якщо файл, на який ви посилаєтесь, порожній або не існує, `Lines` повертає порожній список замість завершення з помилкою. Цикл `range` тоді не виводить нічого, тому посилання на відсутній або порожній файл не спричинить помилку рендерингу шаблону.
