...
:::info
Щоб ділитися фрагментами коду між чартами, використовуйте [бібліотечні чарти](/topics/library_charts.md) замість анкерів YAML. Бібліотечні чарти призначені для повторного використання та не схильні до описаної вище проблеми round-trip.
:::
